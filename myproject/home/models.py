...
channel_choices = [("web", "web"), ("app", "app"), ("email", "email"),
                   ("call", "call"), ("sms", "sms"), ("store", "store")]
browser_choices = [("chrome", "chrome"), ("safari",
                                          "safari"), ("firefox", "firefox")]
os_choices = [("android", "android"), ("ios", "ios"),
              ("windows", "windows"), ("macos", "macos"), ("linux", "linux")]
device_category_choices = [("mobile", "mobile"), ("tablet",
                                                  "tablet"), ("laptop", "laptop"), ("desktop", "desktop")]
source_name_choices = [("Facebook", "Facebook"), ("Google",
                                                  "Google"), ("Youtube", "Youtube"), ("Twitter", "Twitter")]
interract_item_type_choices = [("product", "product"), ("post", "post"), ("blog", "blog"), ("survey", "survey"), ("campaign", "campaign"), (
    "loyaltyprogram", "loyalty program"), ("review", "review"), ("advertisement", "advertisement"), ("mail", "mail")]
user_item_type_choices = [("transaction", "transaction"), ("post", "post"), (
    "blog", "blog"), ("survey", "survey"), ("review", "review"), ("mail", "mail")]
...
class Transaction(models.Model):
    ...
    status      = models.CharField(
        max_length=300, blank=True, null=True, choices=transaction_status_choices)
    record_time = models.DateTimeField(auto_now=True)
...
class ClusterGraph(models.Model):
    ...
    clusterName   = models.CharField(max_length=300, blank=True, default="undefined", null=True)
